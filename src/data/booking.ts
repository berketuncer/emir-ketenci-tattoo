/**
 * Randevu formunun seçenek listeleri. Backend bağlandığında bu değerler
 * doğrudan API sözleşmesine karşılık gelecek şekilde tasarlandı.
 */
...
/** Formun adımları — ilerleme göstergesi bu listeyi kullanır. */
export const bookingSteps = [
  { id: "fikir", title: "Fikir", description: "Ne yaptırmak istiyorsunuz?" },
  { id: "olcu", title: "Ölçü ve bölge", description: "Nereye, ne büyüklükte?" },
  { id: "referans", title: "Referanslar", description: "Aklındaki görseller" },
  { id: "takvim", title: "Tarih ve bütçe", description: "Ne zaman ve hangi aralıkta?" },
  { id: "iletisim", title: "İletişim", description: "Size nasıl ulaşalım?" },
] as const;
